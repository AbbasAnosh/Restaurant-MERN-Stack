      ...
      <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-4 h-full">
        ...
        <div className="xl:col-span-2 h-max rounded-md p-8 sticky top-0">
          ...
          <form className="mt-10">
            <div>
              <h3 className="text-lg font-bold text-[#333] font-font-alt mb-6">
                Personal Details
              </h3>
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="relative flex items-center">
                  <input
                    ...
                    className="px-4 py-3.5 placeholder:text-gray-500 bg-white text-[#333] w-full text-sm border-b-2 border-golden focus:border-yellow outline-none"
                  />
                  <svg
                ...
                <div className="relative flex items-center">
                  <input
                    ...
                    className="px-4 py-3.5 bg-white placeholder:text-gray-500 text-[#333] w-full text-sm border-b-2 border-golden focus:border-yellow outline-none"
                  />
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="#F2C017"
                ...
                <div className="relative flex items-center">
                  <input
                    type="email"
                    placeholder="Email"
                    className="px-4 py-3.5 bg-white text-[#333] placeholder:text-gray-500 w-full text-sm border-b-2 border-golden focus:border-yellow outline-none"
                  />
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="#F2C017"
